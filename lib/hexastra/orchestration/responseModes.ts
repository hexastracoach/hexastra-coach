  ...
  switch (mode) {
    ...
    case 'yearly_priority_answer':
      return [
        ...
        '- TES 3 PRIORITES REELLES: exactement 3 priorites distinctes. Pour chacune: un titre court, Pourquoi:, Dans la vraie vie:. Les plans enrichis peuvent ajouter Cle simple et une radicalite plus marquee.',
        ...
        '- ACTION IMMEDIATE: 1 a 3 actions testables dans les 24 a 72h selon le plan. Format visible conseille: Action 1:, Action 2:, Action 3:.',
        ...
        '- DENSITE PAR PLAN: free tres court et tres lisible. essential clair, utile et actionnable en une lecture. premium plus nuance, plus choix et plus precision. praticien plus strategique, plus differencie, utilisable en accompagnement.',

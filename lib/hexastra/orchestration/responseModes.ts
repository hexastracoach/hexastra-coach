  ...
  switch (mode) {
    ...
    case 'yearly_priority_answer':
      return [
        ...
        '- ORIENTATION: nomme un mouvement concret de l annee, par exemple tri, structuration, expansion selective, visibilite ciblee, consolidation ou repositionnement. Pas d etiquette vague seule.',
        '- TES 3 PRIORITES REELLES: exactement 3 priorites distinctes. Pour chacune: un titre court, pourquoi c est prioritaire cette annee, et ce que cela veut dire dans la vraie vie.',
        '- CE QUI VA TE FREINER: maximum 2 pieges comportementaux precis et contextualises. Interdis les banalites floues.',

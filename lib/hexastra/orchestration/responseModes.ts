  ...
  switch (mode) {
    ...
    case 'yearly_priority_answer':
      return [
        ...
        '- TES 3 PRIORITES REELLES: exactement 3 priorites distinctes. Pour chacune: un titre court, Pourquoi:, Dans la vraie vie:, Cle simple:. Au moins une priorite doit etre radicale et contenir une logique de couper, arreter, supprimer ou refuser.',
        ...
        '- Cle simple: 1 phrase courte qui resume l idee sans abstraction.',
        '- CE QUI VA TE FREINER: 3 a 4 freins comportementaux concrets et reconnaissables. Interdis les banalites floues et les peurs abstraites sans comportement observable.',
        ...
        '- ACTION IMMEDIATE: 2 a 3 actions testables dans les 24 a 72h. Format visible: Action 1:, Action 2:, Action 3:.',
        ...
        '3. Trois ou quatre freins concrets a eviter',
        '4. Bon timing et rythme sur debut / milieu / fin d annee',
        '5. Deux ou trois actions immediates a faire maintenant',

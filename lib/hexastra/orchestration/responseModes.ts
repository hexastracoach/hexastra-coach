  ...
  switch (mode) {
    ...
    case 'yearly_priority_answer':
      return [
        ...
        '- ORIENTATION: nomme un mouvement concret de l annee, par exemple tri, structuration, expansion selective, consolidation ou repositionnement. Interdis les formules vagues du type annee d activation, annee de visibilite ou annee de transformation si elles ne debouchent pas sur une direction concrete.',
        '- TES 3 PRIORITES REELLES: exactement 3 priorites distinctes. Pour chacune: un titre court, pourquoi c est prioritaire cette annee, et ce que cela veut dire dans la vraie vie. Au moins une priorite doit etre radicale et contenir une logique de couper, arreter, supprimer ou refuser.',

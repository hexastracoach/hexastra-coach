...
describe('yearly priority response mode', () => {
  ...
  it('enforces the dedicated annual structure in the directive', () => {
    ...
    expect(directive).toContain('Cle simple')
    expect(directive).toContain('2 a 4 freins')
    expect(directive).toContain('essential = 1 a 2 actions maximum, jamais 3+')
    expect(directive).toContain('maxActions: 2')
    expect(directive).toContain('free = titres tres courts et directs')
    expect(directive).toContain('Pas de Pourquoi detaille')
    expect(directive).toContain('verbes simples')
    expect(directive).toContain('plans enrichis')
